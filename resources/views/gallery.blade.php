...
@section('content')
<!-- Gallery Section without Filter -->
<section class="py-16 bg-gradient-to-b from-blue-50 to-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Galeri <span class="text-blue-600">Kami</span></h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                <img src="{{ $gallery->image_url }}" alt="{{ $gallery->title }}" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110">
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    ...
                    <p class="text-blue-100 text-sm transform translate-y-4 group-hover:translate-y-0 transition duration-300 delay-75">Klik untuk memperbesar</p>
                </div>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-center text-white overflow-hidden relative">
            ...
            <div class="relative z-10">
                <h2 class="text-2xl md:text-3xl font-bold mb-4">Ingin Melihat Lebih Banyak?</h2>
