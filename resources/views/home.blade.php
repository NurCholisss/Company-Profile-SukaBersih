...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Bersihkan rumah lebih mudah dan nyaman dengan produk kebersihan berkualitas tinggi dari kami.</p>
        ...
        <section class="py-16 bg-gradient-to-b from-blue-50 to-white">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 mt-2">Lihat bagaimana kami memproduksi setiap alat kebersihan dengan teliti, dari bahan pilihan hingga siap digunakan di rumah dan bisnis Anda.</p>
                </div>
...
<section class="relative py-24 bg-gradient-to-r from-blue-700 to-blue-800 text-white overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-3xl md:text-4xl font-bold mb-6">Solusi Alat Kebersihan Terjangkau & Berkualitas untuk Rumah dan Usaha Anda!</h2>
            <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Temukan beragam alat kebersihan berkualitas tinggi untuk rumah, kantor, restoran, dan industri.  
                Produk kami dirancang untuk memudahkan pekerjaan Anda: lebih cepat, lebih bersih, dan lebih efisien.  
            </p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('contact') }}"
                   class="px-8 py-4 bg-white text-blue-700 font-semibold rounded-full hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    Hubungi Kami Sekarang
                </a>
                <a href="tel:+6281234567890"
                   class="px-8 py-4 border-2 border-white text-white font-semibold rounded-full hover:bg-white/20 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
