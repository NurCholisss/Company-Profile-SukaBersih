        ...
        @include('admin.partials.sidebar')
            ...
            <div class="p-4 md:p-8">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Tambah Gambar Baru</h1>
                        ...
                        <div class="p-4 md:p-6 grid md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4 md:space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex justify-center px-4 pt-4 pb-5 md:px-6 md:pt-5 md:pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                                        <img id="image-preview" src="#" alt="Pratinjau Gambar" class="hidden max-h-48 md:max-h-64 w-auto">
                                        <span id="no-image" class="text-gray-400 text-sm">Gambar akan muncul di sini</span>
                                    </div>
                                </div>
                            </div>
                        </div>
