        ...
        <main class="ml-64 flex-1 overflow-auto">
            <div class="p-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="{{ route('admin.gallery.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-lg font-semibold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="relative h-56 overflow-hidden group">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                                <h3 class="text-white font-medium">{{ $gallery->title ?? 'Tanpa Judul' }}</h3>
                                <p class="text-blue-100 text-sm">{{ $gallery->created_at->format('d M Y') }}</p>
                            </div>
                        </div>
