            ...
            <div class="p-4 md:p-8">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-4">
                    <div>
                        ...
                        <p class="text-sm md:text-base text-gray-600">Perbarui informasi produk</p>
                    </div>
                        ...
                        <div class="p-4 md:p-6 grid md:grid-cols-2 gap-6 md:gap-8">
                            ...
                            <div class="space-y-4 md:space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="6" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition duration-200">{{ $product->description }}</textarea>
                                </div>
